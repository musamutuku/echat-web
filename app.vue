  ...
  <div>
    <div
      ...
      <div class="flex justify-between mt-4">
        <button class="px-6 text-xs bg-[#031187] rounded-md text-white font-semibold" @click="installPwa">
          Install Now
        </button>
        <button class="flex-1 text-xs rounded-md p-2 text-gray-400 font-semibold"
